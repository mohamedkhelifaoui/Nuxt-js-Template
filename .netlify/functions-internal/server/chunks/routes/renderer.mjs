...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Varta:wght@400;600;700&family=Garamond:wght@400;700&family=Merriweather:wght@400;700&display=swap"}],"style":[],"script":[],"noscript":[]};

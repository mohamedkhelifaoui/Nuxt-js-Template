...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "556ff30f-f0b4-46a7-ba7d-43bf45790691",
...
const _10lrMhxBPCfiSu0tKHBfww501uQyIiuYvkV_S7LMMww = (function(nitro) {
...
const plugins = [
  _10lrMhxBPCfiSu0tKHBfww501uQyIiuYvkV_S7LMMww
];
...
const _bJQuSd = defineCachedEventHandler(async (event) => {
...
const _E_v5MG = lazyEventHandler(() => {
...
const _lazy_W02S3s = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_W02S3s, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _bJQuSd, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _E_v5MG, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_W02S3s, lazy: true, middleware: false, method: undefined }
];

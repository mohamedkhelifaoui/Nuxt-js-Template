import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, h, computed, unref, ref, provide, Suspense, Fragment, createApp, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { k as klona, l as defuFn, h as createError$1, m as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, r as getContext, $ as $fetch$1, t as baseURL, v as createHooks, x as executeAsync, y as toRouteMatcher, z as createRouter$1, A as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-vmSBIteY.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BW6QGXbZ.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D1JpWz53.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DIuu3nxJ.mjs'));
